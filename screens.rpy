...
################################################################################
## Spielinterne Bildschirme (Screens)
################################################################################

image main_menu_bg = "menu_bg.jpg"
...
screen say(who, what):
    ...
    ## Wenn es ein Seitenbild gibt, wird es über dem Text angezeigt. Allerdings
    ## nicht auf der Smartphone-Variante - dort ist kein Platz.
    if not renpy.variant("small"):
        add SideImage() xalign 0.0 yalign 1.0


## Macht das Namensfeld für die Gestaltung durch das Character-Objekt verfügbar.
init python:
...
## Auswahl- oder Entscheidungs-Bildschirm ######################################
##
## Dieser Bildschirm wird verwendet, um die Auswahlmöglichkeiten im Spiel
## anzuzeigen, die von der Menüanweisung präsentiert werden. Der Parameter
## "items" ist eine Liste von Objekten, jedes mit Beschriftung und
## Aktionsfeldern.
##
...
screen quick_menu():
    ...
    ## Stellt sicher, dass dies vor allen anderen Bildschirmen erscheint.
    zorder 100
...
## "vpgrid" sein. Dieser Bildschirm sollte mit einem oder mehreren Unterobjekten
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    frame:
        ...
        hbox:
            ...
            ## Reserviert Platz für den Navigationsbereich.
            frame:
...
## Info-Bildschirm #############################################################
##
## Dieser Bildschirm enthält Würdigungen und Copyright-Informationen über das
## Spiel und Ren'Py.
##
...
## Spielstände-Bildschirm ######################################################
##
## Der load and save Bildschirm sind dafür verantwortlich, dass der Spieler das
## Spiel speichern und wieder laden kann. Da sie fast alles gemeinsam haben,
## sind beide in Form eines dritten Bildschirms, file_slots, implementiert.
##
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Seite {}"), auto=_("Automatic savegames"), quick=_("Quicksaves"))
            ...
            vbox:
                ...
                hbox:
                    ...
                    if config.has_quicksave:
                        textbutton _("{#quick_page}S") action FilePage("quick")

                    ## range(1, 10) liefert die Zahlen von 1 bis 9.
...
##
## Der Einstellungs-Bildschirm ermöglicht es dem Spieler, das Spiel so zu
...
screen history():
    ...
    ## Vermeide es, diesen Bildschirm via "predict" vorberechnen zu lassen, da
    ## er sehr groß sein kann.
    predict False
            ...
            window:
                ...
                if h.who:
                    ...
                    label h.who:
                        ...
                        ## Übernimmt die Farbe des who-Textes des Charakters,
                        ## falls vorhanden.
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Brings the dialogue forward and activates the menu.")

    hbox:
        label _("Leertaste")
        text _("Brings the dialogue forward without choosing a option.")

    hbox:
        label _("Arrow keys")
        text _("Navigates thru the menu.")

    hbox:
        label _("ESC")
        text _("Opens the game menu.")

    hbox:
        label _("Strg")
        text _("Skips dialogue if you hold the key")

    hbox:
        label _("Tab")
        text _("Turns off/on the dialogue skipping")

    hbox:
        label _("Seite hoch")
        text _("Jumps to an earlier dialogue.")

    hbox:
        label _("Seite runter")
        text _("Jumps to an later dialogue.")
    ...
    hbox:
        label "V"
        text _("Turns on supported {a=https://www.renpy.org/l/voicing}Automatic voice generation{/a} ein/aus.")

    hbox:
        label "Shift+A"
        text _("Opens the acessibility menu.")
...
screen mouse_help():
    ...
    hbox:
        label _("Left click")
        text _("It advances the dialogue and activates the interface.")
    ...
    hbox:
        label _("Mousewheel up\nCLick on rollback side")
        text _("Jumps to an earlier dialogue.")

    hbox:
        label _("Mousewheel down")
        text _("Jumps to a later dialogue")
...
screen gamepad_help():
    ...
    hbox:
        ...
        text _("Brings the dialogue forward and activates the interfaces")

    hbox:
        label _("Left trigger\nLeft shoulder")
        text _("Jumps to a earlier dialogue")
    ...
    hbox:
        ...
        text _("Navigates thru the interface.")
...
screen confirm(message, yes_action, no_action):
    ...
    ## Stell sicher, dass andere Bildschirme keine Eingaben erhalten, während
    ...
    ## Ein Rechtsklick oder [ESC] beantworten jeweils mit "Nein".
...
## Dieses Transform wird verwendet, um die Pfeile nacheinander blinken zu
## lassen.
...
## Sprechblasen-Bildschirm #####################################################
##
## Der Sprechblasenbildschirm wird verwendet, um dem Spieler einen Dialog
## anzuzeigen, wenn Sprechblasen verwendet werden. Er benötigt die gleichen
## Parameter wie der Dialog-Bildschirm, muss ein Displayable mit der Id "what"
## erstellen und kann Displayables mit den Ids "namebox", "who" und "window"
## erstellen.
##
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Return") action Rollback()
            textbutton _("Skip") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Auto") action Preference("auto-forward", "toggle")
